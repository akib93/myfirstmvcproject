...
namespace OnlineShopingManagment.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderDetailsId,OrderID,Quentity,UnitPrice")] OrderDetails orderDetails)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderDetailsId,OrderID,Quentity,UnitPrice")] OrderDetails orderDetails)
        {
            if (ModelState.IsValid)
            {
