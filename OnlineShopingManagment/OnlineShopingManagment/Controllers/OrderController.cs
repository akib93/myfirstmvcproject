...
namespace OnlineShopingManagment.Controllers
{
    public class OrderController : Controller
    {
        ...
        {
            var orders = db.Orders.Include(o => o.Invoice).Include(o => o.Product);
        ...
        public ActionResult Create([Bind(Include = "OrderID,Date,quentity,bill,UnitPrice,ProductID,InvoiceID")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderID,Date,quentity,bill,UnitPrice,ProductID,InvoiceID")] Order order)
        {
            if (ModelState.IsValid)
            {
